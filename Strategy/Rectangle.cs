...
namespace MLG360.Strategy
{
    internal abstract class Rectangle
    {
        ...
        private Vector2 TopLeft => Center + new Vector2(-HalfWidth, HalfHeight - Epsilon);
        private Vector2 TopRight => Center + new Vector2(HalfWidth - Epsilon, HalfHeight - Epsilon);
        private Vector2 BottomRight => Center + new Vector2(HalfWidth - Epsilon, -HalfHeight);
